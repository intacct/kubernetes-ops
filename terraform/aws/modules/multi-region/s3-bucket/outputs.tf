...
output "this_s3_bucket_arns" {
  description = "A list of ARN of the bucket. ARN Will be of format arn:aws:s3:::bucketname."
  value       = concat(aws_s3_bucket.this.*.arn, tolist([""]))
}
