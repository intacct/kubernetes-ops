...
variable "key_file" {
  description = "key file to use for connecting to deployed instance"
  type        = string
  default     = ""
}

variable "exec_script" {
  description = "script to be executed after provisioning the instance"
  type        = string
  default     = null
}
...
variable "hostnames" {
  description = "A list of hostnames for each corresponding instance in the VPC"
  type        = list(string)
  default     = []
}
