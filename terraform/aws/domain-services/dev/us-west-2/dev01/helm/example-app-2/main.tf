locals {
  ...
  local_tags = {
    ops_source_repo_path = "${var.base_path}/${var.aws_region}/${var.environment_name}/helm/example-app-2",
  }
...
terraform {
  ...
  backend "remote" {
    ...
    workspaces {
      name = "ds_dev_us-west-2_dev01_helm_example-app-2"
    }
  }
}
...
# Helm - example app
#
# Doc: https://github.com/ManagedKube/example-app-2
module "app" {
